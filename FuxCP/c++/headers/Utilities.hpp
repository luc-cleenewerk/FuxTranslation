...
const IntSet PENULT_THESIS({UNISSON, PERFECT_FIFTH, MINOR_SIXTH, MAJOR_SIXTH});
const IntSet PENULT_Q({UNISSON, MINOR_THIRD, MINOR_SIXTH});
const IntSet DIS({MINOR_SECOND, MAJOR_SECOND, PERFECT_FOURTH, TRITONE, MINOR_SEVENTH, MAJOR_SEVENTH});
...
const vector<int> DIS_VEC = {MINOR_SECOND, MAJOR_SECOND, PERFECT_FOURTH, TRITONE, MINOR_SEVENTH, MAJOR_SEVENTH};
const vector<int> CONSONANCES = {UNISSON, MINOR_THIRD, MAJOR_THIRD, PERFECT_FIFTH, MINOR_SIXTH, MAJOR_SIXTH};
